Old harbor application set using the official harbor helm chart:
          ...
          valuesObject:
            expose:
              ...
              tls:
                ...
                certSource: secret
                auto:
                  # The common name used to generate the certificate, it's
                  # necessary when the type isn't "ingress"
                  commonName: ""
                secret:
